...
modeler.feature_headers = ['topen', 'thigh', 'tlow', 'tclose', 'tvolume', 'lpopen', 'lfopen', 'lphigh', 'lfhigh',
    'lplow', 'lflow', 'lpvolume', 'lfvolume', 'lppricema', 'lfpricema', 'lpvolumema', 'lfvolumema', 'past_buy_profit',
    'past_buy_dd', 'past_buy_time', 'past_buy_dd_time', 'past_sell_profit', 'past_sell_dd', 'past_sell_time',
    'past_sell_dd_time', 'lfclose', 'lpclose' ]
# modeler.feature_headers = ['topen', 'thigh', 'tlow', 'tclose', 'tvolume', 'lfclose', 'lpclose' ]
